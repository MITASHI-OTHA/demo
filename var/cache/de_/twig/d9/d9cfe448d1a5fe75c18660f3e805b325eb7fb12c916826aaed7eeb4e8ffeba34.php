...
class __TwigTemplate_17ca10b4aaa7fed19350ff3afa1fd52f265648261453e9227b9a6d24b33ab8f5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 16
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("build/images/static/error500.jpg"), "html", null, true);
        echo "\" width=\"50%\">
                    </div>
                </div>
        </section>
...
";
    ...
    {
        return array (  101 => 16,  95 => 12,  85 => 11,  67 => 2,  57 => 1,  47 => 11,  45 => 1,);
    }
...
{% block body %}
  <div class=\"container\">
        <section>
                <div class=\"row\">
                    <div class=\"col d-flex my-5\">
                        <img class=\"m-auto\" src=\"{{ asset('build/images/static/error500.jpg') }}\" width=\"50%\">
                    </div>
                </div>
        </section>
  </div>
{% endblock %}", "@Twig/Exception/error500.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/welcoom/templates/bundles/TwigBundle/Exception/error500.html.twig");
    }
}
