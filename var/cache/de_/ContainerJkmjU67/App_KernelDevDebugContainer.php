...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AdMessagesController' => 'getAdMessagesControllerService',
            'App\\Controller\\AdSearchController' => 'getAdSearchControllerService',
            'App\\Controller\\Admin\\AdsController' => 'getAdsControllerService',
            ...
            'App\\Controller\\AdsController' => 'getAdsController2Service',
            'App\\Controller\\BibliothequeController' => 'getBibliothequeControllerService',
            'App\\Controller\\CandController' => 'getCandControllerService',
            'App\\Controller\\ContactInfosController' => 'getContactInfosControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.ads_image' => 'getSmartUniqueNamer_AdsImageService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.welcoom_image' => 'getSmartUniqueNamer_WelcoomImageService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Twig/TwigAdExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('2rXGWdtiAy', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ATdyXtUfv3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('welcoom_image', $e, $f, $g));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('ads_image', $e, $f, $g));
        $d->addEventSubscriber(new \Symfony\Bridge\Doctrine\SchemaListener\PdoCacheAdapterDoctrineSchemaSubscriber([]));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('welcoom_image', $e, $f, $g));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('welcoom_image', $e, $f, $g));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('ads_image', $e, $f, $g));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('ads_image', $e, $f, $g));
        $d->addEventListener([0 => 'loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners');

        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => [], 'serverVersion' => '5.7', 'defaultTableOptions' => []], $a, $d, []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityListenerResolverService()
    {
        $this->services['doctrine.orm.default_entity_listener_resolver'] = $instance = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerEntityListenerResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\EntityListener\\NotifyRegistrationConfirmation' => ['privates', 'App\\EntityListener\\NotifyRegistrationConfirmation', 'getNotifyRegistrationConfirmationService', true],
            'App\\EntityListener\\SetUserAdAuthor' => ['privates', 'App\\EntityListener\\SetUserAdAuthor', 'getSetUserAdAuthorService', true],
        ], [
            'App\\EntityListener\\NotifyRegistrationConfirmation' => '?',
            'App\\EntityListener\\SetUserAdAuthor' => '?',
        ]));

        $instance->registerService('App\\EntityListener\\NotifyRegistrationConfirmation', 'App\\EntityListener\\NotifyRegistrationConfirmation');
        $instance->registerService('App\\EntityListener\\SetUserAdAuthor', 'App\\EntityListener\\SetUserAdAuthor');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AcquereurCandidatureRepository' => ['privates', 'App\\Repository\\AcquereurCandidatureRepository', 'getAcquereurCandidatureRepositoryService', true],
            'App\\Repository\\ActorAdRepository' => ['privates', 'App\\Repository\\ActorAdRepository', 'getActorAdRepositoryService', true],
            'App\\Repository\\AdActeursOperationRepository' => ['privates', 'App\\Repository\\AdActeursOperationRepository', 'getAdActeursOperationRepositoryService', true],
            'App\\Repository\\AdFavorisRepository' => ['privates', 'App\\Repository\\AdFavorisRepository', 'getAdFavorisRepositoryService', true],
            'App\\Repository\\AdImagesRepository' => ['privates', 'App\\Repository\\AdImagesRepository', 'getAdImagesRepositoryService', true],
            'App\\Repository\\AdMessagesRepository' => ['privates', 'App\\Repository\\AdMessagesRepository', 'getAdMessagesRepositoryService', true],
            'App\\Repository\\AdPresentationProjetRepository' => ['privates', 'App\\Repository\\AdPresentationProjetRepository', 'getAdPresentationProjetRepositoryService', true],
            'App\\Repository\\AdRepository' => ['privates', 'App\\Repository\\AdRepository', 'getAdRepositoryService', true],
            'App\\Repository\\AdSubscriptionRepository' => ['privates', 'App\\Repository\\AdSubscriptionRepository', 'getAdSubscriptionRepositoryService', true],
            'App\\Repository\\AdTypeRepository' => ['privates', 'App\\Repository\\AdTypeRepository', 'getAdTypeRepositoryService', true],
            'App\\Repository\\BodyTextRepository' => ['privates', 'App\\Repository\\BodyTextRepository', 'getBodyTextRepositoryService', true],
            'App\\Repository\\CandidatureLightRepository' => ['privates', 'App\\Repository\\CandidatureLightRepository', 'getCandidatureLightRepositoryService', true],
            'App\\Repository\\CandidatureRepository' => ['privates', 'App\\Repository\\CandidatureRepository', 'getCandidatureRepositoryService', true],
            'App\\Repository\\ContactInfosRepository' => ['privates', 'App\\Repository\\ContactInfosRepository', 'getContactInfosRepositoryService', true],
            ...
            'App\\Repository\\DetailsAdRepository' => ['privates', 'App\\Repository\\DetailsAdRepository', 'getDetailsAdRepositoryService', true],
            'App\\Repository\\ImageRepository' => ['privates', 'App\\Repository\\ImageRepository', 'getImageRepositoryService', true],
            'App\\Repository\\LogementActuelRepository' => ['privates', 'App\\Repository\\LogementActuelRepository', 'getLogementActuelRepositoryService', true],
            'App\\Repository\\LogementDesireRepository' => ['privates', 'App\\Repository\\LogementDesireRepository', 'getLogementDesireRepositoryService', true],
            'App\\Repository\\MediaAdsRepository' => ['privates', 'App\\Repository\\MediaAdsRepository', 'getMediaAdsRepositoryService', true],
            'App\\Repository\\MotivationParticipationRepository' => ['privates', 'App\\Repository\\MotivationParticipationRepository', 'getMotivationParticipationRepositoryService', true],
            'App\\Repository\\PostCategoriesRepository' => ['privates', 'App\\Repository\\PostCategoriesRepository', 'getPostCategoriesRepositoryService', true],
            'App\\Repository\\PostRepository' => ['privates', 'App\\Repository\\PostRepository', 'getPostRepositoryService', true],
            'App\\Repository\\PresentationAdRepository' => ['privates', 'App\\Repository\\PresentationAdRepository', 'getPresentationAdRepositoryService', true],
            'App\\Repository\\ResponseMessageCandidatureRepository' => ['privates', 'App\\Repository\\ResponseMessageCandidatureRepository', 'getResponseMessageCandidatureRepositoryService', true],
            'App\\Repository\\RoleRepository' => ['privates', 'App\\Repository\\RoleRepository', 'getRoleRepositoryService', true],
            'App\\Repository\\SituationProfessionnelFinanciereRepository' => ['privates', 'App\\Repository\\SituationProfessionnelFinanciereRepository', 'getSituationProfessionnelFinanciereRepositoryService', true],
            'App\\Repository\\UserContactInfosRepository' => ['privates', 'App\\Repository\\UserContactInfosRepository', 'getUserContactInfosRepositoryService', true],
            ...
            'App\\Repository\\ActorAdRepository' => '?',
            'App\\Repository\\AdActeursOperationRepository' => '?',
            'App\\Repository\\AdFavorisRepository' => '?',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.terminate', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\UserActivitySubscriber'] ?? $this->load('getUserActivitySubscriberService'));
        }, 1 => 'onLastActivity'], 20);
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/assets/images/static'), 'images');
        $a->addPath((\dirname(__DIR__, 4).'/assets/images/web/avatars'), 'avatars');
        ...
        $instance->addExtension(new \App\Twig\TwigAdExtension());
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eAZcJ+OngC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4z0GofWIjH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cdljN2xayH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wTMwEo2sJ7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mkG99kye-J', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('alSPThzjHi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'locale' => 'fr',
            'avatars_directory' => (\dirname(__DIR__, 4).'/assets/images/web/avatars'),
            ...
            'vich_uploader.mappings' => [
                'welcoom_image' => [
                    'uri_prefix' => '/images/web',
                    'upload_destination' => (\dirname(__DIR__, 4).'/assets/images/web'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.welcoom_image',
                        'options' => [
                ...
                'ads_image' => [
                    'uri_prefix' => '/images/web/ads',
                    'upload_destination' => (\dirname(__DIR__, 4).'/assets/images/web/ads'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.ads_image',
                        'options' => [
